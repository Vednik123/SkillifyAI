      ...
      <div className="border-t border-gray-200 pt-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-1">
            ...
            {!isEditing ? (
              <p className="text-gray-900 font-semibold text-base py-1">
                {formData.children?.length || 0} child{formData.children?.length !== 1 ? 'ren' : ''}
              </p>
            ) : (
              <Input
                value={formData.children?.length || 0}
                disabled
                className="h-10 rounded-lg border-gray-300 bg-gray-50 text-gray-500"
              />
            )}
          </div>
        </div>
